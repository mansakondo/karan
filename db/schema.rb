...
ActiveRecord::Schema.define(version: 2021_10_19_092833) do
  ...
  create_table "catalog_marc_record_link_contributions", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "catalog_marc_record_link_subjects", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "catalog_marc_record_links", force: :cascade do |t|
    ...
    t.index ["linkable_type", "linkable_id"], name: "index_catalog_marc_record_links_on_linkable"
